...
add('footer_text', pt_br='Kanban App - Persistencia em arquivos OKF - Python + Flask',
...
add('login_user_not_found', pt_br='Usuario nao encontrado.', en='User not found.', fr='Utilisateur non trouve.', it='Utente non trovato.', zh='找不到用户。')
add('login_user_suspended', pt_br='Usuario suspenso. Contate o administrador.', en='User suspended. Contact the administrator.', fr='Utilisateur suspendu. Contactez l\'administrateur.', it='Utente sospeso. Contatta l\'amministratore.', zh='用户已被暂停。请联系管理员。')
...
add('login_session_expired', pt_br='Sessao expirada. Faca login novamente.', en='Session expired. Please login again.', fr='Session expiree. Veuillez vous reconnecter.', it='Sessione scaduta. Accedi di nuovo.', zh='会话已过期。请重新登录。')
...
add('login_email_invalido', pt_br='Email invalido.', en='Invalid email.', fr='Email invalide.', it='Email non valida.', zh='邮箱无效。')
...
add('dashboard_crie_primeiro', pt_br='Crie seu primeiro quadro Kanban para comecar', en='Create your first Kanban board to get started', fr='Creez votre premier tableau Kanban pour commencer', it='Crea la tua prima lavagna Kanban per iniziare', zh='创建您的第一个看板以开始使用')
add('dashboard_criar_quadro', pt_br='Criar Quadro', en='Create Board', fr='Creer un Tableau', it='Crea Lavagna', zh='创建看板')
add('dashboard_espaco_disco', pt_br='Espaco em disco utilizado', en='Disk space used', fr='Espace disque utilise', it='Spazio disco utilizzato', zh='已用磁盘空间')
...
# Upgrade banner
add('upgrade_banner_uso', pt_br='Voce esta usando', en='You are using', fr='Vous utilisez', it='Stai usando', zh='您正在使用')
...
add('upgrade_banner_texto', pt_br='Faca upgrade para o Plano Comum (R$ 6,99/mes) e tenha ate 20 quadros!',
...
add('board_adicionar_card', pt_br='Adicionar carta', en='Add card', fr='Ajouter une carte', it='Aggiungi carta', zh='添加卡片')
add('board_novo_card', pt_br='Novo Cartao', en='New Card', fr='Nouvelle Carte', it='Nuova Carta', zh='新卡片')
add('board_nova_coluna', pt_br='Nova Coluna', en='New Column', fr='Nouvelle Colonne', it='Nuova Colonna', zh='新列')
add('board_editar_card', pt_br='Editar Cartao', en='Edit Card', fr='Modifier la Carte', it='Modifica Carta', zh='编辑卡片')
add('board_titulo_card', pt_br='Titulo *', en='Title *', fr='Titre *', it='Titolo *', zh='标题 *')
...
add('board_prioridade_media', pt_br='Media', en='Medium', fr='Moyenne', it='Media', zh='中')
add('board_prioridade_alta', pt_br='Alta', en='High', fr='Haute', it='Alta', zh='高')
add('board_data_entrega', pt_br='Data Entrega', en='Due Date', fr='Date d\'echeance', it='Data Scadenza', zh='截止日期')
...
add('board_coluna_concluido', pt_br='Concluido', en='Done', fr='Termine', it='Completato', zh='已完成')
...
add('board_titulo_coluna', pt_br='Titulo da Coluna *', en='Column Title *', fr='Titre de la Colonne *', it='Titolo Colonna *', zh='列标题 *')
add('board_placeholder_coluna', pt_br='ex: Revisao, Aguardando', en='e.g.: Review, Waiting', fr='ex: Revision, En attente', it='es: Revisione, In attesa', zh='例如：审核、待处理')
...
add('admin_global_total_usuarios', pt_br='Total Usuarios', en='Total Users', fr='Total Utilisateurs', it='Totale Utenti', zh='用户总数')
...
add('admin_global_distribuicao', pt_br='Distribuicao por Perfil', en='Profile Distribution', fr='Repartition par Profil', it='Distribuzione per Profilo', zh='角色分布')
add('admin_global_acoes_rapidas', pt_br='Acoes Rapidas', en='Quick Actions', fr='Actions Rapides', it='Azioni Rapide', zh='快捷操作')
add('admin_global_criar_usuario', pt_br='Criar novo usuario', en='Create new user', fr='Creer un nouvel utilisateur', it='Crea nuovo utente', zh='创建新用户')
...
add('admin_global_novo_usuario_btn', pt_br='Novo Usuario', en='New User', fr='Nouvel Utilisateur', it='Nuovo Utente', zh='新用户')
add('admin_global_tabela', pt_br='Usuarios do Sistema', en='System Users', fr='Utilisateurs du Systeme', it='Utenti del Sistema', zh='系统用户')
...
add('th_acoes', pt_br='Acoes', en='Actions', fr='Actions', it='Azioni', zh='操作')
add('th_arquivo', pt_br='Arquivo', en='File', fr='Fichier', it='File', zh='文件')
add('th_usuario', pt_br='Usuario', en='User', fr='Utilisateur', it='Utente', zh='用户')
...
add('perfil_usuario_comum', pt_br='Usuario Comum', en='Common User', fr='Utilisateur Commun', it='Utente Comune', zh='普通用户')

# Modals
add('modal_criar_usuario', pt_br='Criar Usuario', en='Create User', fr='Creer l\'Utilisateur', it='Crea Utente', zh='创建用户')
add('modal_editar_usuario', pt_br='Editar Usuario', en='Edit User', fr='Modifier l\'Utilisateur', it='Modifica Utente', zh='编辑用户')
...
add('modal_id_corp', pt_br='ID Corporacao', en='Corporation ID', fr='ID Societe', it='ID Azienda', zh='企业 ID')
...
add('modal_titulo', pt_br='Titulo', en='Title', fr='Titre', it='Titolo', zh='标题')
...
add('flash_nao_encontrado', pt_br='nao encontrado.', en='not found.', fr='non trouve.', it='non trovato.', zh='未找到。')
...
add('flash_nao_excluir_admin', pt_br='Nao e possivel excluir o Administrador Geral.', en='Cannot delete the General Administrator.', fr='Impossible de supprimer l\'Administrateur General.', it='Impossibile eliminare l\'Amministratore Generale.', zh='无法删除全局管理员。')
add('flash_excluido', pt_br='e seus dados excluidos.', en='and their data deleted.', fr='et ses donnees supprimees.', it='e i suoi dati eliminati.', zh='及其数据已删除。')
...
add('flash_plano_cancelado', pt_br='Assinatura cancelada. Voce esta no plano Gratuito.', en='Subscription cancelled. You are on the Free plan.', fr='Abonnement annule. Vous etes sur le plan Gratuit.', it='Abbonamento annullato. Sei sul piano Gratuito.', zh='订阅已取消。您在使用免费套餐。')
add('flash_plano_invalido', pt_br='Plano invalido.', en='Invalid plan.', fr='Forfait invalide.', it='Piano non valido.', zh='无效套餐。')
add('flash_pagamento_invalido', pt_br='Tipo de pagamento invalido.', en='Invalid payment type.', fr='Type de paiement invalide.', it='Tipo di pagamento non valido.', zh='无效支付类型。')
add('flash_plano_corp_restrito', pt_br='Plano corporativo disponivel apenas para administradores corporativos.',
...
add('account_salvar', pt_br='Salvar Alteracoes', en='Save Changes', fr='Enregistrer les Modifications', it='Salva Modifiche', zh='保存更改')
add('account_info_perfil', pt_br='Informacoes do Perfil', en='Profile Information', fr='Informations du Profil', it='Informazioni Profilo', zh='角色信息')
...
add('planos_por_mes', pt_br='/mes', en='/month', fr='/mois', it='/mese', zh='/月')
add('planos_gratis_propaganda', pt_br='Gratis com Propaganda', en='Free with Ads', fr='Gratuit avec Pub', it='Gratuito con Pubblicita', zh='带广告免费')
...
add('planos_feat_cartoes', pt_br='Cartoes por quadro', en='Cards per board', fr='Cartes par tableau', it='Carte per lavagna', zh='每看板卡片数')
...
add('planos_feat_gestao_corp', pt_br='Gestao corporativa', en='Corporate management', fr='Gestion corporate', it='Gestione aziendale', zh='企业管理')
add('planos_feat_suporte', pt_br='Suporte', en='Support', fr='Support', it='Supporto', zh='支持')
add('planos_feat_comunidade', pt_br='Comunitario', en='Community', fr='Communautaire', it='Community', zh='社区')
add('planos_feat_prioritario', pt_br='Prioritario', en='Priority', fr='Prioritaire', it='Prioritario', zh='优先')
add('planos_feat_multi_usuarios', pt_br='Multiplos usuarios', en='Multiple users', fr='Utilisateurs multiples', it='Utenti multipli', zh='多用户')
...
add('planos_feat_criar_usuarios', pt_br='Criar usuarios sob sua corporacao', en='Create users under your corporation', fr='Creer des utilisateurs sous votre societe', it='Crea utenti nella tua azienda', zh='创建企业下的用户')
...
add('error_404', pt_br='Pagina nao encontrada.', en='Page not found.', fr='Page non trouvee.', it='Pagina non trovata.', zh='页面未找到。')
add('error_429', pt_br='Muitas requisicoes. Aguarde e tente novamente.', en='Too many requests. Please wait and try again.', fr='Trop de requetes. Veuillez attendre et reessayer.', it='Troppe richieste. Attendere e riprovare.', zh='请求过多。请稍后再试。')
